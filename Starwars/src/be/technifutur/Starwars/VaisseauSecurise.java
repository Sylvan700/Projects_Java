...
public class VaisseauSecurise
{
    ...
    // bullet étant private, et donc "sécurisé", des fonctions sont nécessaire pour y avoir accès. Cela permet de controler l'accès aux variables.
    ...
    public VaisseauSecurise(String aName) // Demande dans ses paramètres un nom a la création de l'objet.
    {
